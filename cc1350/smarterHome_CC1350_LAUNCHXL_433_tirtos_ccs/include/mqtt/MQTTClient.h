 ...
 *  @return success code
 */
DLLExport int MQTTSetMessageHandler(MQTTClient* c, const char* topicFilter, messageHandler messageHandler, int correlation);
 ...
 *  @return success code
 */
DLLExport int MQTTSubscribeWithCorrelation(MQTTClient* c, const char* topicFilter, enum QoS qos,
 ...
 *  @return success code
 */
DLLExport int MQTTSubscribeWithResults(MQTTClient* client, const char* topicFilter, enum QoS, messageHandler, MQTTSubackData* data, int correlation);
